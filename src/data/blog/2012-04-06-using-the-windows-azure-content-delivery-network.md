...
I’ve been asked to write an article on this matter, which I did, and which is live at [ACloudyPlace.com](http://acloudyplace.com/2012/04/using-the-windows-azure-content-delivery-network/) since today. As a small teaser, here’s the first section of it:
...
> [![](http://acloudyplace.com/wp-content/uploads/2012/04/CDN1.png)](http://acloudyplace.com/wp-content/uploads/2012/04/CDN1.png)    Another reason for using the CDN is throughput. If you look at a typical webpage, about 20% of it is HTML which was dynamically rendered based on the user’s request. The other 80% goes to static files like images, CSS, JavaScript, and so forth. Your server has to read those static files from disk and write them on the response stream, both actions which take away some of the resources available on your virtual machine. By moving static content to the CDN, your virtual machine will have more capacity available for generating dynamic content.


Here’s the full article: [Using the Windows Azure Content Delivery Network](http://acloudyplace.com/2012/04/using-the-windows-azure-content-delivery-network/)
