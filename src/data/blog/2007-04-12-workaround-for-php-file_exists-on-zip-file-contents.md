...
<p>Assuming regular PHP file functions would be sufficient, I coded the following:
...
<p>The reason for this is unknown to me, but I've written a (dirty) workaround that you can use:
