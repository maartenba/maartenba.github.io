...
<p>Here&rsquo;s the output of the above query:
...
<p>PHPLinq has a second <em>PHPLinq_ILinqProvider</em> built in. This provider makes use of the <a href="http://framework.zend.com" target="_blank">Zend Framework</a> <em>Zend_Db_Table </em>class to provide querying capabilities. First things first: let&rsquo;s create a database table.
...
<p>We can have a look at the generated query by setting an option on PHPLinq, which will tell PHPLinq to pass the generated query to PHP&rsquo;s <em>print</em> function.
