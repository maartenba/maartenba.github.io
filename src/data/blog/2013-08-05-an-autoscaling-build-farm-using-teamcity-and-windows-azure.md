...
[![](/images/image_thumb_262.png)](/images/image_301.png)


Once the machine is started, we will have to install all required prerequisites for our build agent. We can connect using remote desktop (or SSH if it’s a Linux machine). On the machine I have here, I installed all .NET framework versions to ensure I'm able to build .NET projects. On a build machine for Java, we would install the correct runtimes and JDK's for our projects. Anything, really, if it is needed for the sources we’ll be building. On Windows, I typically use [Web Platform Installer](http://www.microsoft.com/web) and [Chocolatey](http://www.chocolatey.org) to get this done as automated as possible.


[![](/images/04_thumb.png)](/images/04.png)
...
[![](/images/05_thumb.png)](/images/05.png)
...
[![](/images/06_thumb.png)](/images/06.png)
...
[![](/images/07_thumb.png)](/images/07.png)
...
[![](/images/08_thumb.png)](/images/08.png)
...
While still connected through remote desktop, open a command prompt and run the *sysprep /generalize* command from the *c:\windows\system32\sysprep* folder. On Linux, there’s a similar option in the [Windows Azure agent](https://www.windowsazure.com/en-us/manage/windows/how-to-guides/capture-an-image/). Sysprep ensures the machine can be cloned into a new machine, getting its own settings like a hostname and IP address. A non-sysprepped machine can thus never be cloned.


[![](/images/09_thumb.png)](/images/09.png)


Once finished, our RDP connection should be gone and our machine can be shutdown in the Windows Azure Management Portal. In fact, it *must* be shut down. Once that is done, we can use the *Capture* button and transform our virtual machine into a template we can create new virtual machines from.[![](/images/image_thumb_263.png)](/images/image_302.png)
...
[![](/images/image_thumb_264.png)](/images/image_303.png)
...
[![](/images/image_thumb_265.png)](/images/image_304.png)
...
[![](/images/image_thumb_266.png)](/images/image_305.png)
...
[![](/images/18_thumb_1.png)](/images/18_1.png)
