...
<p>This is of course not all. <a href="http://www.vrana.cz" target="_blank">Jakub</a> had a couple of sleepless nights, but managed to port in the <a href="http://pear.php.net/package/Spreadsheet_Excel_Writer" target="_blank">PEAR Spreadsheet classes</a>. Meaningless? No! PHPExcel now supports Excel2007 and older versions, too. Want to write an Excel document for Excel200? No problem:
...
<p>There's even a cooler part related to this, and that is .xlsx to .xls conversion! Here's how:
